...
var pagingSlider = {    
    ...
    switchToPage: function(sliderPageContainer, pageId)
    {
        ...
        //To update the time spent on the stop in the database
        app.updateDBbySwitchToPage(app.getUserId(), currentPage);
    ...
    _updatePagePointer: function(sliderPageContainer, pageId)
    {
        ...
        var pointers = document.getElementById("pointers").children[0].children;
        for (var i=0;i<pointers.length;i++){
        	if (pointers[i].className == "active"){
        		pointers[i].removeAttribute("class");  		
        	}
        	
        	pointers[pageId-1].setAttribute("class", "active");
        }
    },
